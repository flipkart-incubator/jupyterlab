...
/* This file was auto-generated by {{funcName}}() in @fk-jupyterlab/buildutils */
`;
...
export async function ensurePackage(
  ...
  if (
    ...
    data.name !== '@fk-jupyterlab/codemirror'
  ) {
  ...
  Object.keys(deps).forEach(name => {
    ...
    if (isTest) {
      const testLibs = ['jest', 'ts-jest', '@fk-jupyterlab/testutils'];
...
/**
 * An extra ensure function just for the @fk-jupyterlab/ui-components package.
 * Ensures that the icon svg import statements are synced with the contents
 * of ui-components/style/icons.
 *
 * @param pkgPath - The path to the @fk-jupyterlab/ui-components package.
